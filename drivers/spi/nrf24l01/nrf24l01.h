...
extern uint32_t	nrf24l01_register(nrf24l01_Drv_TypeDef *driver_private_data);
extern uint8_t nrf24l01_tx(uint8_t handle,uint8_t* tx_payload , uint8_t* tx_address);
extern uint8_t nrf24l01_get_tx_irq_goto_rx(uint8_t handle);
