...
I2C_Sensors_DriverStruct_t	*lps22df_Drv;
	...
	return write_lps22df_reg(lps22df_Drv,LPS22DF_CTRL_REG2,LPS22DF_ONE_SHOT_REG2);
}
...
I2C_Sensors_DriverStruct_t	*lps22df_Drv;
	lps22df_Drv = (I2C_Sensors_DriverStruct_t	*)I2C_DriverStruct[handle].private_data;
	return  HAL_I2C_Master_Receive(lps22df_Drv->bus,lps22df_Drv->device_address, lps22df_Drv->data,LPS22DF_P_LEN, LPS22DF_I2C_TIMEOUT);
}
