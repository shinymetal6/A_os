...
*/
/*
 * sample_process_1_audio_I2S_dual_oscillator.c
 *
...
AUDIO_FAST_RAM q15_t	Audio_Synth1_buf_left[I2S_EFFECT_SIZE];
__attribute__ ((aligned (32)))	AUDIO_Source_TypeDef Audio_Synth1_left =
{
	.block_size = I2S_EFFECT_SIZE,
	.out_buf = (q15_t *)Audio_Synth1_buf_left,
	.channel = 1,
	.flags = SOURCE_ENABLED,
	.sample_rate = SAMPLE_FREQUENCY,
};

AUDIO_FAST_RAM int16_t	mixer_buf0_left[I2S_EFFECT_SIZE];
MIXER_Effect_TypeDef	MIXER_Left_Effect_0 =
{
	.effect = Effect_MIXER,
	.effect_init = Effect_MIXER_Init,
	.out_buf = mixer_buf0_left,
	.in_buf_ch2 = Audio_Synth1_buf_left,
	.pan = &adc1_buf[2],
...
{
	.in_buf = (int16_t *)mixer_buf0_left,
...
void sample_process_1_init(uint32_t process_id)
{
	...
	Synth_Register(LEFT_CHANNEL ,&Audio_Synth1_left);
	i2s_driver_register(&I2S_Driver);
...
void sample_process_1_audio_I2S_dual_oscillator(uint32_t process_id)
{
...
uint8_t		cntr = 0;
	...
	Sound_Insert_Effect((uint32_t *)&Audio_Synth0_left,(uint32_t *)&MIXER_Left_Effect_0);
...
#endif // #ifdef SAMPLEPROCESS_1_AUDIO_I2S_DUAL_OSCILLATOR
