...
{
uint16_t	i;
	if ( (BlockEffect[REVERB_EFFECT_ID].effect_status & EFFECT_ENABLED) == EFFECT_ENABLED )
	{
...
{
	BlockEffect[REVERB_EFFECT_ID].num_params = 0;
	sprintf(BlockEffect[REVERB_EFFECT_ID].effect_name,"Reverb");
	BlockEffect[REVERB_EFFECT_ID].apply_effect =  Do_Echo;
	BlockEffect[REVERB_EFFECT_ID].effect_status &= ~EFFECT_ENABLED;
