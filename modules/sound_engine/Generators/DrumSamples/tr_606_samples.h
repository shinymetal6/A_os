...
const uint32_t TR606_kick_length = 68;
...
const uint32_t TR606_snare_length = 54;

// ===========================
// 3. LOW TOM
// ~80 Hz damped oscillator
// ===========================
const int16_t TR606_low_tom[] = {
...
const uint32_t TR606_low_tom_length = 34;

// ===========================
// 4. MID TOM
// ~120 Hz
// ===========================
const int16_t TR606_mid_tom[] = {
...
const uint32_t TR606_mid_tom_length = 32;

// ===========================
// 5. HIGH TOM
// ~180 Hz
// ===========================
const int16_t TR606_high_tom[] = {
    0,  300,  550,  720,  810,  820,  760,  650,
  500,  340,  180,   40, -100, -210, -280, -310,
 -300, -260, -200, -140, -90, -50, -20,  -5,
    5,    8,    6,    3,    1,    0
};
const uint32_t TR606_high_tom_length = 29;

// ===========================
// 6. CLOSED HI-HAT
// Short metallic burst (~8 kHz content)
// ===========================
const int16_t TR606_hh[] = {
   800, -600,  500, -400,  300, -250,  200, -150,
   100,  -80,   60,  -50,   40,  -30,   20,  -15,
    10,   -8,    6,   -5,    4,   -3,    2,   -1,
     1,    0
};
const uint32_t TR606_hh_length = 26;

// ===========================
// 7. RIMSHOT
// Sharp wooden transient
// ===========================
const int16_t TR606_rimshot[] = {
   900, -700,  400, -300,  200, -150,  100,  -80,
    60,  -50,   40,  -30,   20,  -15,   10,   -8,
     6,   -5,    4,   -3,    2,   -1,    1,    0
};
const uint32_t TR606_rimshot_length = 24;

/*
DrumVoice voices[NUM_VOICES] = {
    { kick,    kick_length,     0, 1.0f, 0 },
    { snare,   snare_length,    0, 0.9f, 0 },
    { low_tom, low_tom_length,  0, 0.8f, 0 },
    { mid_tom, mid_tom_length,  0, 0.8f, 0 },
    { high_tom,high_tom_length, 0, 0.8f, 0 },
    { hh,      hh_length,       0, 0.7f, 0 },
    { rimshot, rimshot_length,  0, 0.7f, 0 }
};
*/
