...
*/
/*
 * sample_process_1_dac_waveforms.c
 *
...
/* tim6 frq = DAC_AUDIO_BUF_SIZE * freq = 1024*1000
 * tim6 period = 1 / 1024000 period = 977 nS -> rounded to 980 nS
 * regs @480 MHz ( 240MHz timer ) -> prescaler : 24 , period = 10 -> 1000 nS
 */

#define	DAC_AUDIO_BUF_SIZE	1024
__attribute__ ((aligned (32))) int16_t sine_wavetable[DAC_AUDIO_BUF_SIZE] =
{
...
__attribute__ ((aligned (32))) int16_t	dac_buffer[DAC_AUDIO_BUF_SIZE];

__attribute__ ((aligned (32)))	DAC_Drv_TypeDef DAC_Drv =
{
	.dac = &hdac1,
	.dac_timer = &htim6,
	.dac_buffer = sine_wavetable,
	.dac_sample_frequency = (float ) (DAC_AUDIO_BUF_SIZE*1000*1000),
...
void sample_process_1_dac_waveforms(uint32_t process_id)
{
...
#endif // #ifdef SAMPLEPROCESS_1_DAC_WAVEFORMS
